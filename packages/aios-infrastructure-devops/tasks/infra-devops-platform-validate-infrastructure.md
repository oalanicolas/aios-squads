...
To comprehensively validate platform infrastructure changes against security, reliability, operational, and compliance requirements before deployment. This task ensures all platform infrastructure meets organizational standards, follows best practices, and properly integrates with the broader AIOS ecosystem.
...
### 6. AIOS Integration Assessment

- Review how platform infrastructure changes support other AIOS agents:
...
6. **AIOS integration assessment results** for complete platform stack
